"""Map line endpoints to window ids and text character intervals.

This module centralizes geometry/projection helpers that were previously
duplicated across bundle construction and coverage counting scripts.
"""
...
def line_window_ids_from_endpoint(
    ...
    *,
    ...
    Sampling strategy is intentionally unchanged from current pipeline behavior:
    step count is ``max(dx, dy) + 1``, points are rounded and clipped to axis
    bounds, and returned ids are sorted unique integers.
    """
