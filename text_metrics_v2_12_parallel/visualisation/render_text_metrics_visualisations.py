...
def save_text_metrics_visualisations(
    *,
    ...
    line_filter_label: str = "v2.12_true_IoU",
    ...
    The visual content remains unchanged. Only stale v2.1 labels are renamed to
    v2.12-consistent names.
    """
    ...
    return {
        ...
        "visualise_after_v2_12_true_iou_path": after_filtering_path,
