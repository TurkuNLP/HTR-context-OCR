...
DOCUMENT_RESULT_FIELDNAMES = [
    ...
    "line_levenshtein_filter_stage",
    "pre_iou_line_levenshtein_filter_enabled",
    "raw_falling_line_count_before_pre_iou_levenshtein",
    "raw_falling_line_count_after_pre_iou_levenshtein",
    "raw_falling_line_levenshtein_removed_count",
    "raw_falling_line_levenshtein_threshold",
    "pre_iou_line_levenshtein_min",
    "pre_iou_line_levenshtein_max",
    "pre_iou_line_levenshtein_mean",
    "pre_iou_line_levenshtein_seconds",
    "hough_per_run_counts_json",
    "hough_segment_run_hit_counts_json",
