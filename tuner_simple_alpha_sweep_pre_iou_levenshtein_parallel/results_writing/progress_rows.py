...
from tuner_simple_alpha_sweep_pre_iou_levenshtein_parallel.dynamic_pool.document_pool import DocumentLease
from tuner_simple_alpha_sweep_pre_iou_levenshtein_parallel.results_writing.flat_csv_tables import DOCUMENT_RESULT_FIELDNAMES, DOCUMENT_TABLE_FIELDNAMES, SKIPPED_FIELDNAMES
from tuner_simple_alpha_sweep_pre_iou_levenshtein_parallel.serial_runner.document_runner import DocumentRunResult
...
def build_progress_row(
    *,
    ...
    attempt_counter: int,
    panel_path: str | None,
    alpha_sweep_pickle_path: str | None,
    ...
    progress_row: dict[str, Any] = {
        ...
        "alpha_sweep_pickle_path": str(alpha_sweep_pickle_path or ""),
        "has_runfile_row": "1",
