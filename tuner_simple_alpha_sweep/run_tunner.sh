...
# Resolve the real tuner_simple_alpha_sweep directory, even when Slurm runs a copied script from /var/spool/slurmd.
SCRIPT_SOURCE_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
# Allow advanced users or Slurm wrappers to point directly at the checked-out tuner_simple_alpha_sweep directory.
