...
from tuner_simple_alpha_sweep.document_selection.document_filters import select_documents
...
def run_simple_tuner(config: PipelineConfig, *, log) -> dict[str, Any]:
    ...
    if config.plot_mode != "none":
        from tuner_simple_alpha_sweep.plotting.stitched_language_panels import SimplePlotManager
