...
PROJECT_ROOT_RESULTS="${PROJECT_ROOT_RESULTS:-/scratch/project_2017385/dorian/Churro_copy/results/count_line_character_coverage_results}"
...
Visual/output switches:
  --visualize                       Enable coverage plot output.
  --visual-output <path>            Optional explicit PNG output path.
  --visual-title <text>             Optional plot title.
