#!/usr/bin/env bash
#SBATCH --job-name=text_metrics_report_v2_1
...
#SBATCH --mem=96G
#SBATCH --chdir=/scratch/project_2017385/dorian/Churro_copy/text_metrics_v2_1
#SBATCH -o /scratch/project_2017385/dorian/Churro_copy/logs/text_metrics_report_v2_1_%j.out
#SBATCH -e /scratch/project_2017385/dorian/Churro_copy/logs/text_metrics_report_v2_1_%j.err
...
SCRIPT_DIR="/scratch/project_2017385/dorian/Churro_copy/text_metrics_v2_1"
cd "${SCRIPT_DIR}"
...
echo "[run] text_metrics_report_v2_1"
