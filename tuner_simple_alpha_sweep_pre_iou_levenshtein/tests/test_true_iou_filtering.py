...
from tuner_simple_alpha_sweep_pre_iou_levenshtein.probabilistic_hough import hough_detection as hough_detection_module
from tuner_simple_alpha_sweep_pre_iou_levenshtein.probabilistic_hough.hough_detection import filter_lines_by_column_ownership
from tuner_simple_alpha_sweep_pre_iou_levenshtein.filtering.filter_overlap_merging import (
    coverages_have_enough_true_iou,
    coverages_merge_candidate,
)
from tuner_simple_alpha_sweep_pre_iou_levenshtein.filtering.filter_candidate_coverages import build_line_coverage, coverage_from_path
...
def test_final_line_sorting_remaps_column_assignment_ids() -> None:
    from tuner_simple_alpha_sweep_pre_iou_levenshtein.filtering.filter_final_assignment import sort_final_lines_and_remap_assignment
