...
_METRICS_DIR = _PROJECT_ROOT / "text_metrics_v2_1"
for _path in (str(_METRICS_DIR), str(_PROJECT_ROOT)):
...
from runfile_records import (
    load_run_items as _shared_load_run_items,
    safe_name as _shared_safe_name,
    same_file as _shared_same_file,
)
from score_matrix_builder import (
    compute_score_matrix as _shared_compute_score_matrix,
    sliding_segments as _shared_sliding_segments,
)
