...
"""Reference-self cache warm-up for exhaustive Hough tuning.

This module fills the exact ``ref_to_ref`` combination cache without evaluating
    ...
    for line_length in line_length_values:
        for line_gap in line_gap_values:
            for seed in seed_values:
                ...
                ref_to_ref_cache.get_or_compute(
                    doc=doc,
                    hough_threshold=threshold,
                    hough_line_length=line_length,
                    hough_line_gap=line_gap,
