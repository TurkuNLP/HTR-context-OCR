...
from tuner_parallel_v2_1.metrics.v2_12_metric_adapter import (
    get_external_v212_metric_functions,
    get_v212_metric_functions,
)
from tuner_parallel_v2_1.metrics.alignment_quality_score import (
    compute_weighted_along_lines_similarity_from_bundle,
    compute_weighted_along_lines_similarity_from_compact_payload,
)
from tuner_parallel_v2_1.metrics.v2_12_compat.line_coverage_arrays import (
...
from tuner_parallel_v2_1.metrics.v2_12_compat.line_metric_bundle import (
...
def test_default_v212_adapter_uses_tuner_local_compat_package() -> None:
    ...
    assert "tuner_parallel_v2_1" in str(functions.text_metrics_v212_dir)
