...
SHARDS_DIR="${SHARDS_DIR:-/scratch/project_2000539/dorian/results/tuner_parallel_v2_1_dynamic_pool_example/shards}"
OUTPUT_DIR="${OUTPUT_DIR:-/scratch/project_2017385/dorian/Churro_copy/tuner_parallel_v2_1/_language_hough_parameter_metric_visuals_script}"
