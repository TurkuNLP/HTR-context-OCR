...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            "Legacy compatibility flag (no-op). "
            "Plot output path is ignored in this script."
        ),
    )
    parser.add_argument(
        "--visual-title",
        ...
        help=(
            "Legacy compatibility flag (no-op). "
            "Figure title is ignored in this script."
        ),
    )
    parser.add_argument(
        "--output-json",
...
def _derive_filtered_line_endpoints(
    *,
    ...
    """Derive filtered line endpoints with the shared line-alignment pipeline."""
...
def count_text_on_lne(
    ...
    *,
    ...
    if visualize:
        # Plotting is intentionally centralized in visualise_used_lines_from_report.py.
        # Keep the flag for CLI compatibility, but do not render here.
        pass
