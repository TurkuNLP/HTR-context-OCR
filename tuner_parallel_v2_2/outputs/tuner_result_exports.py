...
def _metric_payload_from_best(best: dict) -> dict:
    ...
    return {
        ...
        "alignment_selection_score": _finite_float_or_none(best.get("alignment_selection_score")),
        "score_matrix_support": _finite_float_or_none(best.get("score_matrix_support")),
        "line_guided_fraction": _finite_float_or_none(best.get("line_guided_fraction")),
        ...
        rows.append(
            {
                ...
                **_metric_payload_from_best(best),
                ...
                "min_surviving_line_nls": _finite_float_or_none(best.get("min_surviving_line_nls")),
                "line_nls_filter_enabled": bool(best.get("line_nls_filter_enabled", False)),
                "line_nls_filter_input_line_count": _int_or_default(best.get("line_nls_filter_input_line_count", 0)),
                "line_nls_filter_scored_line_count": _int_or_default(best.get("line_nls_filter_scored_line_count", 0)),
                "line_nls_filter_removed_line_count": _int_or_default(best.get("line_nls_filter_removed_line_count", 0)),
                "line_nls_filter_surviving_line_count": _int_or_default(best.get("line_nls_filter_surviving_line_count", 0)),
                "line_nls_filter_removed_column_count": _int_or_default(best.get("line_nls_filter_removed_column_count", 0)),
                "line_nls_filter_surviving_column_count": _int_or_default(best.get("line_nls_filter_surviving_column_count", 0)),
                "line_nls_filter_all_lines_removed": bool(best.get("line_nls_filter_all_lines_removed", False)),
                "line_nls_filter_all_removed_combination_count": _int_or_default(
                    rec.get("line_nls_filter_all_removed_combination_count", 0)
                ),
        ...
        for value in sorted(int(v) for v in values_map.keys()):
            ...
            for point in doc_rows:
                ...
                row = {
                    ...
                    "alignment_selection_score": _finite_float_or_none(point.get("alignment_selection_score")),
                    "score_matrix_support": _finite_float_or_none(point.get("score_matrix_support")),
                    "line_guided_fraction": _finite_float_or_none(point.get("line_guided_fraction")),
                    "average_weighted_normalised_levenshtein_similarity": _finite_float_or_none(
                    ...
                    "metric_outcome_reason": point.get("metric_outcome_reason"),
                    "normalised_levenshtein_similarity": _finite_float_or_none(point.get("whole_document_nls")),
                    "min_surviving_line_nls": _finite_float_or_none(point.get("min_surviving_line_nls")),
                    "line_nls_filter_enabled": int(bool(point.get("line_nls_filter_enabled", False))),
                    "line_nls_filter_input_line_count": _int_or_default(point.get("line_nls_filter_input_line_count", 0)),
                    "line_nls_filter_scored_line_count": _int_or_default(point.get("line_nls_filter_scored_line_count", 0)),
                    "line_nls_filter_removed_line_count": _int_or_default(point.get("line_nls_filter_removed_line_count", 0)),
                    "line_nls_filter_surviving_line_count": _int_or_default(point.get("line_nls_filter_surviving_line_count", 0)),
                    "line_nls_filter_removed_column_count": _int_or_default(point.get("line_nls_filter_removed_column_count", 0)),
                    "line_nls_filter_surviving_column_count": _int_or_default(point.get("line_nls_filter_surviving_column_count", 0)),
                    "line_nls_filter_all_lines_removed": int(bool(point.get("line_nls_filter_all_lines_removed", False))),
