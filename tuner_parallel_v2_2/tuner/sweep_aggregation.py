...
def compact_best_curve_row(best: dict | None) -> dict | None:
    ...
    return {
        ...
        "mean_alignment_selection_score": best.get("mean_alignment_selection_score"),
        "mean_score_matrix_support": best.get("mean_score_matrix_support"),
        "mean_line_guided_fraction": best.get("mean_line_guided_fraction"),
...
def point_from_best(*, doc: SweepDocument, best_eval: dict | None, baseline_cfg: HoughBaselineConfig) -> dict:
    ...
    if best_eval is None or not is_finite_tuning_score(best_eval.get("tuning_score")):
        return {
            ...
            "fname": str(doc.fname),
            "tuning_score": None,
            "alignment_selection_score": None,
            "score_matrix_support": None,
            "line_guided_fraction": None,
