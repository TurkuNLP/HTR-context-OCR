...
try:
    ...
    from ..tuner.tuner_config import MATRIX_CACHE_VERSION, LogFn
except ImportError:
    from matrices.pkl_index_readonly import parse_ws_st_from_scores_pkl_name  # type: ignore
    from tuner.tuner_config import MATRIX_CACHE_VERSION, LogFn  # type: ignore
