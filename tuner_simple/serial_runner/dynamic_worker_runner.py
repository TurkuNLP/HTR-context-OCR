...
from tuner_simple.document_selection.runfile_loader import RunfileDocument, load_runfile_documents
from tuner_simple.dynamic_pool.document_pool import DocumentLease, DocumentPool
from tuner_simple.matrix_operations.matrix_loader import build_score_matrix_indexes
from tuner_simple.plotting.atomic_panel_writer import render_atomic_document_panel
from tuner_simple.results_writing.locked_csv_bucket import LockedCsvBucketWriter
from tuner_simple.results_writing.progress_rows import PROGRESS_FIELDNAMES, build_progress_row
from tuner_simple.serial_runner.document_runner import process_one_document
...
def run_atomic_document_worker(config: PipelineConfig, *, log) -> dict[str, Any]:
    ...
    panel_root_dir = output_dir / "plots" / "document_panels"
